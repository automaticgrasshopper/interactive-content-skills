...
from validate_mainline_story_input import validate_frozen as validate_mainline_story_input


CONTRACT_VERSION = "nextplay.episode-mainline-story.v1"
RECEIPT_VERSION = "nextplay.episode-mainline-story-review.v2"
...
COMPREHENSION_FIELDS = {
    ...
    "readable_progression": "可读叙事推进",
}
REQUIRED_CHECKS = ["六组输入边界", "人物按需进入", "连续因果", "关键真相", "必保事件", "期待性类型兑现", "非资料清单"]
...
def validate_review(packet_value: dict[str, Any], review: dict[str, Any]) -> list[str]:
    ...
    for key in ("mainline_sha256", "mainline_story_input_sha256"):
