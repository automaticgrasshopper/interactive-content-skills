...
def episode_object(
    ...
    return {
        ...
        "选择节点": {
            "是否为选择节点": yes_no(
                subsection(choice_block, "是否为选择节点"),
                "是否为选择节点",
            ),
            "是否有选择问题": yes_no(
                subsection(choice_block, "是否有选择问题"),
                "是否有选择问题",
            ),
            "选择节点编号": subsection(choice_block, "选择节点编号"),
            "选择问题": subsection(choice_block, "选择问题"),
            "选项列表": options,
        },
        "互动节点": {
            "是否为互动节点": yes_no(
                subsection(interaction_block, "是否为互动节点"),
                "是否为互动节点",
            ),
            "互动节点编号": subsection(interaction_block, "互动节点编号"),
            "后边是否接选择节点": yes_no(
                subsection(interaction_block, "后边是否接选择节点"),
                "后边是否接选择节点",
            ),
            "后续选择节点编号": subsection(
                interaction_block,
...
def main() -> int:
    ...
    print(
        ...
        "v0.1.53 gates and business output contract verified"
    )
    return 0
