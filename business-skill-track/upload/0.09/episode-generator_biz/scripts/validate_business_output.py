...
def validate(
    ...
    for index, item in enumerate(episodes):
        ...
        has_choice = choice["是否为选择节点"] is True
        ...
        if has_choice != (choice["是否有选择问题"] is True) or has_choice != (interaction["后边是否接选择节点"] is True):
            issues.append(f"{node_id}/互动节点与选择节点标记不一致")
