...
ACTION_FIELDS = {"action_id", "action_text", "immediate_consequence", "core_goal_status", "route_ended", "ending_reason", "goal_status_explanation"}
...
def read_audit(cache_root: Path) -> tuple[Path, dict[str, Any]]:
    ...
    for index, fissure in enumerate(fissures, 1):
        ...
        for action in actions:
            ...
            if len(goal_explanation) < 12 or not any(term in goal_explanation for term in ("完整", "公开", "阻止", "录音", "听证")):
