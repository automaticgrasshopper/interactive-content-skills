...
from stage_three_release import verify as verify_stage_three_release


BUSINESS_SKILL_VERSION = "episode-generator-biz/0.27"
...
def build_business_output(
    ...
    issues.extend(verify_stage_three_release(cache_root))
