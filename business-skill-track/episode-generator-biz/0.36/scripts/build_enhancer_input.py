...
def build(draft: Path, boundary: str, enhancer_reference: Path, dialogue_reference: Path) -> str:
...
def main() -> int:
    ...
    try:
        value = build(args.draft, args.boundary, args.enhancer_reference, args.dialogue_reference)
