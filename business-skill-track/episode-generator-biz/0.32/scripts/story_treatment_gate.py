...
RECEIPT_VERSION = "nextplay.episode-story-treatment-review.v4"
TREATMENT_NAME = "story-treatment.json"
RECEIPT_NAME = "story-treatment-review.json"
ROOT_FIELDS = {"contract_version", "title", "mainline_sha256", "complete_story", "choices", "endings"}
...
def validate_review(packet_value: dict[str, Any], review: dict[str, Any]) -> list[str]:
    ...
    for key in (
        "treatment_sha256", "mainline_sha256", "emotional_movement_sha256", "stage_two_input_sha256", "run_basis_sha256", "asset_catalog_sha256",
