...
class ExecutionResultProtocolTests(unittest.TestCase):
    ...
    def test_content_failure_rolls_back_to_full_regeneration_edge(self):
        ...
        self.assertEqual(episode["state"], "ADAPTED")
        self.assertNotIn("WRITE_EPISODE", episode["outputs"])
    ...
    def test_retry_exhaustion_stops_without_asking_user(self):
        state = {
            ...
            "episodes": {
                "episode-001": {
                    "state": "ADAPTED",
                    "content_failures": {"WRITE_EPISODE": run_state.MAX_CONTENT_ATTEMPTS},
                }
            },
        }
