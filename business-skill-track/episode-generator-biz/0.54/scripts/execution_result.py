...
RECOVERY_ACTIONS = {
    ...
    "build_episode_artifact.py": "REWRITE_EPISODE",
    ...
    "episode_quality_gate.py": "REREVIEW_EPISODE",
    "episode_structure_gate.py": "REWRITE_EPISODE",
    ...
    "validate_character_appearances.py": "REWRITE_EPISODE",
    ...
    "validate_episode.py": "REWRITE_EPISODE",
    "validate_execution_integrity.py": "REMOVE_UNAUTHORIZED_CACHE_SOURCE",
