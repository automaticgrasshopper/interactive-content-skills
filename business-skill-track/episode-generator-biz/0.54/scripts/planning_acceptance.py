...
from validate_mainline_emotional_movement import validate as validate_mainline_emotional_movement
...
REQUIRED_FILES = (
    ...
    "mainline-decomposition.json", "mainline-emotional-movement.json", "mainline-path.json", "mainline-projection-review.json",
...
def content_leaves(cache_root: Path) -> dict[str, Any]:
    global_names = (
        "user-request.md", "user-intent-lock.json", "creative-brief.json",
        "complete-story.json", "mainline-decomposition.json", "mainline-emotional-movement.json", "mainline-path.json",
...
def build(cache_root: Path) -> dict[str, Any]:
    ...
    errors.extend(validate_mainline_emotional_movement(cache_root))
    ...
    errors.extend(validate_emotional_topology(
        cache_root, cache_root / "topology.md", cache_root / "emotional-spine.json",
