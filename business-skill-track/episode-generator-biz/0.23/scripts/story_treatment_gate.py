...
RECEIPT_VERSION = "nextplay.episode-story-treatment-review.v1"
...
def read_treatment(cache_root: Path) -> tuple[Path, dict[str, Any]]:
    ...
    for ending in endings:
        ...
        if len(title) < 2 or title in ending_titles:
...
def validate_review(packet_value: dict[str, Any], review: dict[str, Any]) -> list[str]:
    ...
    for key in (
        "treatment_sha256", "run_basis_sha256", "asset_catalog_sha256",
