...
正式拓扑必须经过强制两版生成。两版都只能读取当前完整故事、主线分解、主线情绪运动和已通过的支线故事图。第一版保存为`topology-draft-1.md`后立即废弃，不得成为任何下游材料的事实源。第二版必须重新从同一冻结材料推导，并且图形指纹与第一版不同；不得读取或修补第一版，改名、换编号、改选项文字或仅换节点文案也不构成新形状。只有`topology.md`这个第二版可进入路线记账、节点级情绪脊、梗概和正文。
