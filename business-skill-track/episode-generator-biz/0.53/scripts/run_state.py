...
CONTENT_RECOVERY = {
    "ADAPT": ("QUEUED", set()),
    "WRITE_COMPACT_DRAFT": ("ADAPTED", {"ADAPT"}),
    "VALIDATE_COMPACT_DRAFT": ("ADAPTED", {"ADAPT"}),
    "ENHANCE": ("COMPACT_DRAFT_VALIDATED", {"ADAPT", "WRITE_COMPACT_DRAFT", "VALIDATE_COMPACT_DRAFT"}),
    "VALIDATE_STRUCTURE": ("COMPACT_DRAFT_VALIDATED", {"ADAPT", "WRITE_COMPACT_DRAFT", "VALIDATE_COMPACT_DRAFT"}),
    "ACCEPT_EPISODE": ("STRUCTURE_VALIDATED", {"ADAPT", "WRITE_COMPACT_DRAFT", "VALIDATE_COMPACT_DRAFT", "ENHANCE", "VALIDATE_STRUCTURE"}),
}
