...
RECEIPT_VERSION = "nextplay.episode-story-treatment-review.v3"
...
def validate_review(packet_value: dict[str, Any], review: dict[str, Any]) -> list[str]:
    ...
    for key in (
        "treatment_sha256", "emotional_movement_sha256", "stage_two_input_sha256", "run_basis_sha256", "asset_catalog_sha256",
