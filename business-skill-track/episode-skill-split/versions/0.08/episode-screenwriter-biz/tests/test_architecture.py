...
class ArchitectureTests(unittest.TestCase):
    ...
    def test_manifest_inherits_007(self):
        manifest = json.loads((ROOT / "reference-manifest.json").read_text(encoding="utf-8"))
        self.assertEqual(manifest["based_on"], "episode-screenwriter-biz/0.07")
        self.assertEqual(manifest["skill_version"], "episode-screenwriter-biz/0.08")
