...
- `public_identity`说明观众可知的身份，`identity_anchor`是必须自然进入首次出场正文的最短身份词（如“记者”“东闸现场负责人”），`current_relevance`说明人物为何与当前任务有关；三者缺一不得开始写作，不得只凭角色名猜职业、权限或关系。
...
- `quality_checks`至少覆盖路线忠实、停止边界、连续性、首次出场、非台词场面化和资产一致性；正文含对白时再覆盖对白，分支来源节点再覆盖`choice_readiness`，且每个冻结选项至少有一条不同的正文证据。每项证据必须能在正文中逐字定位。
