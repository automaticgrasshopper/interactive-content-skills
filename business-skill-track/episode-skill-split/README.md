...
- `episode-screenwriter-biz/0.16`：从 0.15 的运行能力干净复制，一次只为一个指定节点完成或追改分集剧本；Skill 包自身不感知研发版本。
...
`episode-screenwriter-biz/0.16` 保持 0.15 的全部运行能力和文件边界，但移除 Skill 内部的版本 manifest 与研发版号感知。版本关系只由 Git、版本目录及 Skill 外部发布记录维护。
